...
- [MSW v2 설정](#msw-v2-설정)
- [핸들러 작성](#핸들러-작성)
- [핸들러 Co-location](#핸들러-co-location)
- [Vitest 통합](#vitest-통합)
- [에러/지연 시나리오](#에러지연-시나리오)
- [테스트별 핸들러 오버라이드](#테스트별-핸들러-오버라이드)
- [인증 시나리오](#인증-시나리오)
- [타입 안전한 핸들러](#타입-안전한-핸들러)
...
src/
  features/
    users/
      api/
        handlers.ts     ← 사용자 관련 MSW 핸들러
      components/
      hooks/
    posts/
      api/
        handlers.ts     ← 게시글 관련 MSW 핸들러
      components/
  mocks/
    handlers.ts         ← 모든 핸들러를 모아서 export
